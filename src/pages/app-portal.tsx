...
const featuredApps: FeaturedApp[] = [
  {
    ...
    iconSrc: '/images/app-portal/featured/qariah_icon_web_optimized.webp',
  ...
  },
  {
    ...
    background:
      "linear-gradient(180deg, rgba(5, 18, 52, 0.5), rgba(5, 18, 52, 0.7)), url('/images/app-portal/featured/quran_kareem_banner_web_optimized.webp')",
...
const appTiles: AppTile[] = [
  ...
  // -------------------------------------------
  {
    ...
    visual:
      "linear-gradient(180deg, rgba(0, 64, 34, 0.38), rgba(0, 64, 34, 0.55)), url('/images/app-portal/mandala_web_optimized.jpg')",
    iconSrc: '/images/app-portal/icon_web_optimized.png',
    iconAlt: 'QuranMeet',
  ...
  // -------------------------------------------
  {
    ...
    visual:
      "linear-gradient(180deg, rgba(80, 30, 0, 0.32), rgba(80, 30, 0, 0.55)), url('/images/app-portal/calligraphy_web_optimized.png')",
    iconSrc: '/images/app-portal/icon_web_optimized.png',
    iconAlt: 'ReadTafsir',
  ...
  // -------------------------------------------
  {
    ...
    visual:
      "linear-gradient(180deg, rgba(40, 40, 80, 0.32), rgba(40, 40, 80, 0.55)), url('/images/app-portal/mandala_web_optimized.jpg')",
    iconSrc: '/images/app-portal/icon_web_optimized.png',
    iconAlt: 'Tafsir App',
  ...
  // -------------------------------------------
  {
    ...
    visual:
      "linear-gradient(180deg, rgba(0, 80, 90, 0.32), rgba(0, 80, 90, 0.55)), url('/images/app-portal/calligraphy_web_optimized.png')",
    iconSrc: '/images/app-portal/icon_web_optimized.png',
